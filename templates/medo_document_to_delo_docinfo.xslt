        ...
        <sev:Header Version="1.0" MessageType="MainDoc" MessageID="$TRANSPORT_UID" ReturnID="$RETURN_UID" ResourceID="0" Time="$TIME">
            ...
            <sev:Recipient>
				<sev:Contact>
                    <sev:Organization>
						<xsl:attribute name="UID">
							<xsl:value-of select="/xdms:communication/xdms:deliveryIndex/xdms:destination/xdms:destination/@xdms:uid" />
                        </xsl:attribute>
                        <sev:ShortName>
                            <xsl:value-of select="/xdms:communication/xdms:deliveryIndex/xdms:destination/xdms:destination/xdms:organization" />
                        </sev:ShortName>
                    </sev:Organization>
                </sev:Contact>
            </sev:Recipient>
            ...
            <sev:Document Type="Created" MainDocument='true' UID="$DOCUMENT_UID">
                ...
                <xsl:for-each select = "/xdms:communication/xdms:files/xdms:file">
                    <sev:File UID="$FILE_UID" Size="0">
                        ...
                        <sev:Extension>
                            <xsl:value-of select="substring-after($lname,'.')" />
                        </sev:Extension>
                    </sev:File>
                </xsl:for-each>
                ...
                <xsl:for-each select = "/xdms:communication/xdms:document/xdms:signatories/xdms:signatory">
                    <sev:Author>
                        <sev:Contact>
                            <sev:Organization>
                                <xsl:attribute name="UID">
                                    <xsl:value-of select="/xdms:communication/xdms:header/xdms:source/@xdms:uid" />
                                </xsl:attribute>
                                <sev:ShortName>
                                    <xsl:value-of select="/xdms:communication/xdms:header/xdms:source/xdms:organization"/>
                                </sev:ShortName>
                            ...
                            <sev:OfficialPerson>
                                ...
                                <sev:Post><xsl:value-of select="./xdms:post" /></sev:Post>
                            </sev:OfficialPerson>
                            <sev:Address>
